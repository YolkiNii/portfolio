...
export default function ProjectCard({
  ...
  return (
    <div className="text-center max-w-[750px] rounded-lg">
      ...
      <div className="grid grid-cols-5 gap-1 mx-auto mt-2">
        {usedTechnologies.map((tech) => {
          return (
            <p key={tech} className="bg-light-pink rounded-full font-bold w-4/5 mx-auto text-red-orange">{tech}</p>
          )
        })}
      </div>
    </div>
